...
const MintNFT = () => {
    ...
    const ListNFT = async () => {
        ...
        const ContractAsa = await sdk.getContract("0x8dFC041Fa157f6AE4cE93BC58f47Df39A3FC2540");
        ...
        const signedPayload = await contract.erc721.mintTo(Account, MetadataWithSupply);
                            ...
                            <label className="switch">
                                ...
                                <div className="flip-card__inner">
                                    ...
                                    <div className="flip-card__back" id='upload'>
                                        ...
                                        </label> : <><img src={Image} style={{ background: "#000" }} id='imageuploaded' alt='No Image is Given' /></>}
                                    </div>
                                </div>
                            </label>
                        </div>
                            ...
                            <div className="cardop">
                                ...
                                <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                    <button className="buttonop" onClick={async (e) => {
                                        ...
                                        const result= await contract.erc721.burn(TokenIdToBurn)
                                        console.log(result);
                                        generateToast();
                                    }}>Burn</button>
